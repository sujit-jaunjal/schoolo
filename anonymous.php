            ...
            <div class="card-group">
                <div class="card">
                    <div class="alert alert-primary" role="alert">
                        Hey there ! You are texting as - <img src="images/anonymous.png" class="rounded-circle" alt="User Image" width="50" height="50"> <b>Anonymous</b>
                    </div>
                    <div class="card-body">
                        ...
                        <form method="POST">
                            <div class="input-group">
                                <input class="form-control" type="text" id="avatar_name" name="avatar_name" placeholder="Text to...">
...
<footer class="page-footer">
    ...
    <div class="footer" style="background-image:url('images/bg.jpg')">©Developer:
        <a href="">Sujit Jaunjal<small>(sujitjaunjal4801@gmail.com)</small></a>
    </div>
    <!-- Copyright -->
</footer>
