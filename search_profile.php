                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                ...
                                if ($_SESSION['unknown'] != true) {
                                    if ($num != null) {
                                ?>
                                        <input type="submit" class="btn btn-primary" style="background-color:lightgreen" name="disconnect" value="Connected">
                                    <?php
                                    } elseif ($num1 != null) {
                                    ?>
                                        <input type="submit" style="background-color:yellow; color:black;" class="btn btn-primary" name="disconnect" value="Requested">
                                    <?php
                                    } else {
                                    ?>
                                    ...
                                    ?>
                                    <input type="submit" class="btn btn-secondary" name="msg" value="Message"><br><br>
                                <?php
                                } else {
                                ?>
                                    <input type="submit" class="btn btn-secondary" name="msg" value="Message"><br><br>
