...
if (mysqli_connect_error()) {
    ...
    $run = "SELECT * FROM `registration` WHERE id='$id'";
            ...
            <div class="card-group">
                <div class="card">
                    <div class="alert alert-primary" role="alert">
                        <h2 style="font-family:serif;">Shared Posts -</h2>
                    </div>
                    <div class="card-body" style="overflow-y:scroll;">
                        ...
                        ?>
                                <div class="form-group" id="th">
                                    ...
                                    <u> <b>Caption</b></u> -<br> <?php echo $row['caption']; ?><br><br>
                                    <?php
                                    ...
                                    ?>
                                    <small><b>Shared on</b> -<br> <?php echo $date->format($datetimeFormat); ?><br><br></small><br><br>
                                </div>
                        <?php
                            }
                        }
