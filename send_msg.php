...
if (mysqli_connect_error()) {
    ...
    $query = "SELECT * FROM `registration` WHERE avatar='$search'";
    ...
    $read = "UPDATE messages SET read_user='1' WHERE id2 = '$id1' AND id1='$id2'";
    ...
    if (isset($_POST['submit'])) {
        ...
        $text = $_POST['text'];
        $timestamp = time();
        if ($_SESSION['unknown'] == true) {
            if ($text != null) {
                $msg = "INSERT INTO `messages`(id1, id2, user1, user2,anonymous, u_message, msg_time, read_user) VALUES('$id1', '$id2', '$user1_uk', '$user2', '1', '$text', '$timestamp','0');";
            }
        } else {
            $msg = "INSERT INTO `messages`(id1, id2, user1, user2,anonymous, u_message, msg_time, read_user) VALUES('$id1', '$id2', '$user1', '$user2', null,'$text', '$timestamp','0');";
        }
        ...
        <div class="col-md-6" style="margin-top: 50px;">
            <div class="card-group">
                <div class="card" style="height: 550px;">
                    ...
                    <div class="card-body" id="#messageBody" style="overflow-y:scroll;">
                        <?php
                            ...
                            <div class="col-md-11">
                                <form method="POST">
                                    <p class="lead emoji-picker-container">
                                        <textarea class="form-control" data-emojiable="true" data-emoji-input="unicode" name="text" placeholder="Enter text..."></textarea>
                                    </p>
                            </div>
                            <div class="col-md-1">
