...
if (mysqli_connect_error()) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $cap = $_POST['caption'];
        $timestamp = time();
        $resultant = "INSERT INTO `post`(user_id, image, caption, image_timestamp, like_from) VALUES('$id','$folder','$cap', '$timestamp','0')";
            ...
            <div class="card-group">
                <div class="card" style="background-image: url(images/bg.jpg);">
                    <div class="alert alert-primary" role="alert">
                        <h2 style="font-family:serif;">Post -</h2>
                        <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <img id="imageResult" src="images/anonymous.png" alt="" style="height: 250px; width:250px;" class="img-fluid rounded shadow-sm mx-auto d-block">

                            <div class="form-group">
                                <label for="caption">Caption :</label>
                                <textarea name="caption" class="form-control" placeholder="Enter Caption..."></textarea>
                            </div>
                            <br>
                            <br>
